<div class="row align-items-center">
    <div class="mx-auto  col-5 mb-2">
        <div class="card rounded shadow" style="zoom:85%">
            <h5 class="text-dark ml-2 text-center mt-1 pt-1">Selamat datang, silahkan login</h5>
            <div class=" card-body ">
                <form method="post" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="modal-footer col-12  py-1">
                            <p class="text-dark">Belum punya akun?</p>
                            <a href="Daftar" class="btn btn-sm  btn-primary">Daftar</a>
                            <button name="login" value="1" class="btn btn-sm  btn-pink2">login</button>
                        </div>
                    </div>
                </form>
            </div>
